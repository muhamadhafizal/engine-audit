            ...
            if($resultecm == 'E' || $resultecm == '1A' || $resultecm == '1C'){
                ...
                if($resultecm == '2D'){
                    ...
                    if($subinventorydetails && $sumplytariff){
                        $annual_energy_cost = (($power_rating_of_lamp / 1000 * (float)$subinventorydetails->loadfactory) * $number_of_lamp * (float)$subinventorydetails->peakdurationcostoperation * (float)$sumplytariff->structurepeak + ($power_rating_of_lamp * (float)$subinventorydetails->loadfactory / 1000) * $number_of_lamp * (float)$subinventorydetails->offpeakduration * (float)$sumplytariff->structureoffpeak) * (float)$subinventorydetails->annualoperationdays;
                    } else {
